    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
          <Card><CardContent className="p-4 sm:p-6"><div className="flex flex-col items-center text-center gap-3 sm:flex-row sm:items-center sm:text-left sm:gap-3"><div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0"><DollarSign className="w-5 h-5 text-primary" /></div><div><p className="text-xs sm:text-sm text-muted-foreground">Revenue (Selected Range)</p><p className="text-xl sm:text-2xl font-bold">KES {totalRevenue.toLocaleString()}</p></div></div></CardContent></Card>
          <Card><CardContent className="p-4 sm:p-6"><div className="flex flex-col items-center text-center gap-3 sm:flex-row sm:items-center sm:text-left sm:gap-3"><div className="w-10 h-10 rounded-full bg-success/20 flex items-center justify-center flex-shrink-0"><Recycle className="w-5 h-5 text-success" /></div><div><p className="text-xs sm:text-sm text-muted-foreground">Materials (Selected Range)</p><p className="text-xl sm:text-2xl font-bold">{totalMaterials.toLocaleString()} kg</p></div></div></CardContent></Card>
          <Card><CardContent className="p-4 sm:p-6"><div className="flex flex-col items-center text-center gap-3 sm:flex-row sm:items-center sm:text-left sm:gap-3"><div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0"><TrendingUp className="w-5 h-5 text-accent" /></div><div><p className="text-xs sm:text-sm text-muted-foreground">Growth Rate</p><p className={`text-xl sm:text-2xl font-bold ${parseFloat(growthRate) >= 0 ? 'text-success' : 'text-destructive'}`}>{parseFloat(growthRate) >= 0 ? '+' : ''}{growthRate}%</p></div></div></CardContent></Card>
          <Card><CardContent className="p-4 sm:p-6"><div className="flex flex-col items-center text-center gap-3 sm:flex-row sm:items-center sm:text-left sm:gap-3"><div className="w-10 h-10 rounded-full bg-info/20 flex items-center justify-center flex-shrink-0"><BarChart3 className="w-5 h-5 text-info" /></div><div><p className="text-xs sm:text-sm text-muted-foreground">Avg. per Period</p><p className="text-xl sm:text-2xl font-bold">KES {Math.round(totalRevenue / nonZeroPeriods).toLocaleString()}</p></div></div></CardContent></Card>
        </div>
